...
<div class="mdl-layout-spacer"></div>
		<div class="mdl-cell mdl-cell mdl-card mdl-shadow--2dp emprunt-retour">
			<div class="mdl-card__title">
				<h2>Retour</h2>
			</div>
			<form method="post">
				<div class="mdl-card__supporting-text">
					Veuillez donner le numéro du document à retourner :
					<div class="fill mdl-textfield mdl-js-textfield mdl-textfield--floating-label">      
						...
						<label class="mdl-textfield__label" for="numero">Numéro du document à retourner...</label>
					</div>
				</div>
